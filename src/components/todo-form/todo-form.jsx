...
const TodoForm = ({onButtonClick}) => {
  ...
  return (
      <form className="form" onSubmit={handleSubmit}>
        <label className="form__label" htmlFor="user">Ваше имя</label>
        <input
        ...
        />
        <label className="form__label" htmlFor="desc">Описание задачи</label>
        <textarea
          onChange={handleFieldChange}
          className="form__field"
          id="desc"
        ...
        />
        <label className="form__label" htmlFor="status">Статус выполнения</label>
        <input
          onChange={handleFieldChange}
          className="form__field"
          id="status"
